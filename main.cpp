...
{
    pq::Value::Param::Opt::target = {10.0, 10.0, 10.0};
    ...
    */
    /*
     ...
     auto fr_foot = robot_dart::Robot::create_ellipsoid(
         {0.01, 0.01, 0.01}, {0, 0, 0, 0, 0, 0}, "free", 1, dart::Color::Red(1.0), "fr_foot");
     auto fl_foot = robot_dart::Robot::create_ellipsoid(
         {0.01, 0.01, 0.01}, {0, 0, 0, 0, 0, 0}, "free", 1, dart::Color::Red(1.0), "fl_foot");
     auto rr_foot = robot_dart::Robot::create_ellipsoid(
         {0.01, 0.01, 0.01}, {0, 0, 0, 0, 0, 0}, "free", 1, dart::Color::Red(1.0), "rr_foot");
     auto rl_foot = robot_dart::Robot::create_ellipsoid(
         {0.01, 0.01, 0.01}, {0, 0, 0, 0, 0, 0}, "free", 1, dart::Color::Red(1.0), "rl_foot");
     ...
     simu.add_robot(box);
     simu.add_robot(fr_foot);
     simu.add_robot(fl_foot);
     simu.add_robot(rr_foot);
     simu.add_robot(rl_foot);
